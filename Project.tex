...
\begin{enumerate}
	\item \textbf{Map size}: We generated pathways using 5$\times$5-size grids, so each grid had a total of 25 hidden states.
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\linewidth]{data/Profile_1/mapping.png}
	\caption{Grid 1}
\end{figure}
...
\begin{figure}[H]
	...
	\includegraphics[width=0.8\linewidth]{data/Profile_2/mapping.png}
	\caption{Grid 2}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\linewidth]{data/Profile_3/mapping.png}
	\caption{Grid 3}
\end{figure}
